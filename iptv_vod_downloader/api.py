...
def build_headers(user_agent: str = DEFAULT_USER_AGENT) -> dict[str, str]:
    """Build default headers with a custom User-Agent."""
    return {
...
class IPTVClient:
    ...
    def __init__(
        ...
        self._session.headers.update(build_headers(self.user_agent))
        self.timeout = (5, 60)
